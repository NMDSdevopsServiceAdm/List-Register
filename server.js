...
const routesRegister = require("./app/routes-register.js");
const routesSprint1 = require("./app/routes-sprint-1.js");
const routesSprint2 = require("./app/routes-sprint-2.js");
...
if (typeof routesRegister !== "function") {
  console.log(routesRegister.bind);
  console.log(
    "Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes."
  );
  routes.bind(app);
...
if (typeof routesSprint2 !== "function") {
  console.log(routesSprint2.bind);
  console.log(
    "Warning: the use of bind in routes is deprecated - please check the Prototype Kit documentation for writing routes."
  );
  routesSprint2.bind(app);
} else {
  app.use("/sprint-2/", routesSprint2);
}
